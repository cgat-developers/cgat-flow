...
import CGATPipelines.tasks.Intervals as PipelineIntervals
import CGATPipelines.tasks.Motifs as PipelineMotifs
import CGATPipelines.tasks.Windows as PipelineWindows
