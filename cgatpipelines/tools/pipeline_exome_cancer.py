...
def indelCaller(infile, outfile):
    ...
    exome.strelkaINDELCaller(infile, infile_tumour, outfile,
...
def intersectHeatmap(infiles, outfile):
    ...
    exome.intersectionHeatmap(infiles, outfile)
...
def summariseFiltering(infile, outfile):
    ...
    exome.parseMutectCallStats(infile, outfile, submit=True)
...
def defineEBioStudies(outfile):
    ...
    exome.defineEBioStudies(cancer_types, outfile, submit=False)
...
def extractEBioinfo(infiles, outfile):
    ...
    exome.extractEBioinfo(eBio_ids, vcfs, outfile, submit=False)
...
def mutationalSignature(infiles, outfiles):
    ...
    exome.compileMutationalSignature(
        infiles, outfiles)
