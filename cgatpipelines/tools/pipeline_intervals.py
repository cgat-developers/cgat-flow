...
def exportMotifIntervalSequences(infile, outfile):
    ...
    This method requires the _interval tables.
    '''
    motifs.exportSequencesFromBedFile(
        infile, outfile,
...
def runMeme(infile, outfile):
    ...
    * Sequence is run through dustmasker
    ...
    '''
    motifs.runMEMEOnSequences(infile, outfile)
...
def runTomTom(infile, outfile):
    ...
    motifs.runTomTom(infile, outfile)
...
def loadMast(infile, outfile):
    ...
    '''
    motifs.loadMAST(infile, outfile)
...
def computeReadCountsInIntervals(infiles, outfile):
    ...
    windows.countReadsWithinWindows(tagfile,
                                            bedfile,
                                            outfile,
...
def aggregateReadCounts(infiles, outfile):
    ...
    per interval set.
    '''
    windows.aggregateWindowsReadCounts(infiles,
                                               outfile,
                                               regex='_vs_([^.]*)\..*')
